...
public class BinaryHashTreeImpl<E extends Comparable<E>> implements BinaryTree<E> {
    private final Logger LOG = LoggerFactory.getLogger(getClass());
    Node<E> root;

    public BinaryHashTreeImpl(E root) {
        this.root = new Node<>(root);
    }

    public BinaryHashTreeImpl() {
        createExampleTree();
    }
    ...
    private Node<E> add(Node<E> currentNode, E value) {
        ...
        if (value.hashCode() < currentNode.getValue().hashCode()) {
            currentNode.setLeftChild(add(currentNode.getLeftChild(), value));
        } else if (value.hashCode() > currentNode.getValue().hashCode()) {
    ...
    private boolean containsNode(Node<E> node, E value) {
        ...
        return value.hashCode() < node.getValue().hashCode() //
